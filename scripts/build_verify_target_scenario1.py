...
# -*- coding: utf-8 -*-
"""
从「情景1（压力）验证文件」抽取六张输出工作表，生成情景1权威目标 fixture：
    data_input/fixtures/verify_targets_scenario1.json
...
从而使情景1 验证模块六表比对差异归零（与基础情景 / verify_targets.json 模式一致）。

用法：
    python scripts/build_verify_target_scenario1.py
"""
import os
import sys
import json
...
SOURCE_FILE = r'D:\IFRS17预测模型\验证文件\IFRS17财务预测_情景1.xlsx'
FIXTURE_DIR = os.path.join(ROOT, 'data_input', 'fixtures')
OUTPUT_FILE = os.path.join(FIXTURE_DIR, 'verify_targets_scenario1.json')
