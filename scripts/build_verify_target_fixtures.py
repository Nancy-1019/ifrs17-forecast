...
# -*- coding: utf-8 -*-
"""
从「情景0（基础情景）验证文件」抽取六张输出工作表，生成基础情景权威目标 fixture：
    data_input/fixtures/verify_targets.json
...
SOURCE_FILE = r'D:\IFRS17预测模型\验证文件\IFRS17财务预测_情景0.xlsx'
